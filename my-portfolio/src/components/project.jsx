            ...
            >
              ...
              <div className={`space-y-6 ${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <button className="bg-green-600 text-white px-6 py-3 font-mono font-semibold hover:bg-green-700 transition-colors duration-200 border-2 border-green-600 flex items-center justify-center space-x-2">
                    <ExternalLink size={16} />
                    <span>View Live Demo</span>
                  </button>
                  <button className="border-2 border-gray-300 text-gray-700 px-6 py-3 font-mono font-semibold hover:border-green-600 hover:text-green-600 transition-colors duration-200 flex items-center justify-center space-x-2">
                    <Github size={16} />
                    <span>View Code</span>
                  </button>
                </div>
        ...
        <div className="text-center mt-16 pt-12 border-t border-gray-200">
          <div className="bg-green-50 border border-green-200 rounded-lg p-8 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border-2 border-green-600 text-green-600 px-6 py-3 font-mono font-semibold hover:bg-green-600 hover:text-white transition-colors duration-200">
                Download CV
              </button>
            </div>
          </div>
